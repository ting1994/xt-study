...
<div class="zbl_mybaseinfo" style="overflow-x:hidden;height:100vh;">
	...
	<div class="body">
		...
		<mt-cell title="*国籍">
			<span style='margin-right:25px;color:grey' v-if='getPersonInfo'>{{getPersonInfo.nationalityText}}</span>
		</mt-cell>
		<mt-cell title="*证件类型">
			<span style='margin-right:25px;color:grey' v-if='getPersonInfo.certificate'>{{getPersonInfo.certificate.certificateTypeText}}</span>
		</mt-cell>
		<mt-cell title="*证件号码">
			<span style='margin-right:25px;color:grey' v-if='getPersonInfo.certificate'>{{getPersonInfo.certificate.certificateNo.slice(0,-4) + '****'}}</span>
		</mt-cell>
		...
		<mt-cell title="*手机号码">
			<span class="phoneNo" style='margin-right:25px;color:grey' v-if='getPersonInfo.phoneNo'>{{getPersonInfo.phoneNo.slice(0,3) + '****' + getPersonInfo.phoneNo.slice(7,11)}}</span>
		</mt-cell>
