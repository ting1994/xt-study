<template>
<div class="zbl_qyxq_edit" style="overflow-x:hidden;height:100vh;">
    <div class="header">
    ...
    <div class="body">
        ...
        <div class="container">
            <mt-cell title="家庭医生" is-link @click.native='showTeamDetail'>
                <span class="hideMore" v-if='docTeam' style="
                color:#000;
                ...
                word-break:keep-all;
                white-space:nowrap;
                text-overflow:ellipsis;">{{docTeam}}</span>
            </mt-cell>
            <mt-cell title="服务包" is-link @click.native='requestServerPackage'>
                <span class="hideMore" v-if='servicePackageName' style="
                color:#000;
                display: inline-block;
                width: 4.5rem;
                text-align:right;
                ...
                word-break:keep-all;
                white-space:nowrap;
                text-overflow:ellipsis;">{{servicePackageName}}</span>
            </mt-cell>
        ...
        reqAjax() {
            ...
            commonAjaxKy(JSON.stringify(params), 'pcn.residentSignService', 'getSignRecordDetail').then(res => {
                if (res.code === 200) {
                    ...
                    this.shequyiyuan = this.mockData.applySignInfo.orgName
