        ...
        <div class="header">
	        ...
	        <div class="header_bottom">
	        	<div class="calculate_result">
	        		<p>预产期</p>
	        		<p>{{expectedDate}}</p>
	        		<div class="remainder_days" id="ring">
	        			<div class="pie_left">
	        				<div class="left" id="ringLeft"></div>
	        			</div>
    					<div class="pie_right">
    						<div class="right" id="ringRight"></div>
    					</div>
...
export default {
    ...
    mounted() {
        ...
        var num = 360*(280-this.birthCountdown)/280;
        if (num<=180) {
        	this.a('ringRight').style.transform = "rotate(" + num + "deg)";
        } else {
        	this.a('ringRight').style.transform = "rotate(180deg)";
        	this.a('ringLeft').style.transform = "rotate(" + (num - 180) + "deg)";
        }
...
.remainder_days{
    ...
    display: -ms-flexbox;
    display: flex;*/
    /*background-image: -webkit-linear-gradient(-36deg, transparent 50%, #ddd 50%), -webkit-linear-gradient(left, #ddd 50%, #028cd5 50%);*/
    /*background-image: linear-gradient(126deg, transparent 50%, #ddd 50%), linear-gradient(90deg, #ddd 50%, #028cd5 50%);*/
}
.pie_left, .pie_right {
	position: absolute;
    width: 130px;
