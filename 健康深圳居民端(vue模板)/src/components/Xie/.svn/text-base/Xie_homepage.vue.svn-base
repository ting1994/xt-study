...
<div class="header_grop">
	<div class="home_header">
		...
		<a class="xie_qh" href='http://mshop.taivexmhealth.com/pcn-core/h5/h5ys/index.html' style="color:#fff">切换</a>
	</div>
	<div class="home_input">
		<div class="phone">
			...
			<div class="home_nopwd">
				<span @click='$router.push("/xie_forget_password")'>忘记密码？</span>
				<span @click='$router.push("/xie_register")'>注册</span>
			</div>
		</div>
	</div>
</div>
