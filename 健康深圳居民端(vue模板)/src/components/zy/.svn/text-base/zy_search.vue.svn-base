    ...
    methods: {
        ...
        nextRouter(index){
            ...
            if(this.bizType[index] == "01"){
                ...
                this.$router.push({path: '/zy_departDoctorInfo', query: {hospitalId: this.searchResult[index].hospitalId,departmentId:this.searchResult[index].departmentId}})
            }else if(this.bizType[index] == "04"){
                this.$router.push('/xie_hospital')
                this.$router.push({path: '/xie_mydoc',query: {orgId: this.searchResult[index].hospitalId}})
            }
        },
        addSearch(content){
