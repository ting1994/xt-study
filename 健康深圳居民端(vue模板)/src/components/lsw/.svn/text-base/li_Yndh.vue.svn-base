...
//				"body": {
//					"id": 21240,
//					"userId": "cec402c4-4693-4d28-a0c8-6684a1a33dec",
//					"password": "c162758bd1f68550f01ba5c1bdba16a14fc9749f04dce4688e040fe43ca667e7",
//					"roleId": "patient",
//					"tenantId": "hcn.shenzhen",
//					"manageUnit": "hcn",
//					"lastLoginTime": "2017-08-29 11:00:31",
...
//				},
//				"properties": {
//					"accessToken": "23580d58-3a39-4b96-82ca-902345eacca6"
//				}
//			}
...
//			console.log(this.tenantId)
			//请求首页拿的doctorid
			let params = [this.tenantId,this.userId]
			commonAjaxKy(JSON.stringify(params), 'pcn.residentSignService', 'querySignApplyInfo')
				.then(res => {
					if(res.code === 200) {
						console.log(res.body)
						var arr = res.body
						console.log(arr)
						for(var item in arr) {
							console.log(arr.doctorId)
							sessionStorage.setItem("doctorId", arr.doctorId)
						}
					}
				})
		},
