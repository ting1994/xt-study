...
export default new Router({
	...
	routes: [
		...
		//忘记密码
		{
			path: '/xie_modify_password',
			meta: {
				keepAlive: false
			},
			component: resolve => require(['../components/Xie/xie_modify_password.vue'], resolve)
		},
		//验证码
		{
			path: '/xie_verification',
			meta: {
				keepAlive: false
			},
			component: resolve => require(['../components/Xie/xie_verification.vue'], resolve)
		},
		//修改密码
		{
			path: '/xie_forget_password',
			meta: {
				keepAlive: false
			},
			component: resolve => require(['../components/Xie/xie_forget_password.vue'], resolve)
		},
		//忘记密码
...
//		居民消息页面
			...
			// 跳转科室医生详情
		{
			...
			// 跳转服务计划
		{
			path: '/zy_service_plan',
			meta: {
				keepAlive: false
			},
			component: resolve => require(['../components/zy/zy_service_plan.vue'], resolve)
		},
			// 跳转咨询记录
		{
			path: '/zy_consult_record',
			meta: {
				keepAlive: false
			},
			component: resolve => require(['../components/zy/zy_consult_record.vue'], resolve)
		},
		{
			path: '/tangyouquan',
			meta: {
		...
		//我的家庭儿童
		{
			path: '/myFamilyChildren',
			meta: {
				keepAlive: false
			},
			component: resolve => require(['../components/ssj/ssj_my_familyChildren.vue'], resolve)
		},
		//儿童接种疫苗情况
		{
			path: '/childVaccinationStatus',
			meta: {
				keepAlive: false
			},
			component: resolve => require(['../components/ssj/ssj_child_vaccinationStatus.vue'], resolve)
		},
		//疫苗介绍
		{
			path: '/vaccinePresentation',
			meta: {
				keepAlive: false
			},
			component: resolve => require(['../components/ssj/ssj_vaccine_presentation.vue'], resolve)
		},
		//我的收藏
		{
			...
			component: resolve => require(['../components/ssj/ssj_my_collection.vue'], resolve)
		},
		//健康活动消息列表
		{
			path: '/HealthActivityNews',
			meta: {
				keepAlive: false
			},
			component: resolve => require(['../components/ssj/ssj_healthActivity_newsList.vue'], resolve)
		},
		//健康宣教
		{
			...
			component: resolve => require(['../components/ssj/ssj_health_education.vue'], resolve)
		},
		//健康宣教详情
		{
			...
			component: resolve => require(['../components/ssj/ssj_healthEducation_details.vue'], resolve)
		},
		//<!--张炳林路由开始-->
		//测试页
		{
		...
		//落地页面
		{
			...
			component: resolve => require(['../components/zbl/downloadpage.vue'], resolve)
		},
		//<!--张炳林路由结束-->
	]
})
